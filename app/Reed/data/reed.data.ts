...
export const data: reedData = {
  ...
  rulesLeft: [
    ...
    { id: 3, text: "Una vez abonado y confirmado el turno, no se admitirán cancelaciones.", type: "no" },
  ],
  rulesRight: [
    ...
    { id: 6, text: "Al solicitar un turno, el consultante acepta estas condiciones de contratación.", type: "yes" },
  ],
};