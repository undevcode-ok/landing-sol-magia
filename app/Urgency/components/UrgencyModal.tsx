    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: 20,
          boxShadow: "0 0 80px rgba(192,57,43,0.2), 0 0 0 1px rgba(255,255,255,0.04) inset",
      ...
      >
        ...
        <div className="relative h-44 overflow-hidden">
          ...
          />
          <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 20%, #0f0303 100%)" }}/>
        </div>
        ...
        <div className="relative z-10 px-7 pb-7 pt-2">
          ...
          <h3
            ...
            style={{ fontFamily: "var(--font-cormorant), serif", fontSize: 46 }}
          >
            {urgencyData.title}
          </h3>
          ...
          {/* Recargo pill */}
          <span
            className="inline-block mt-2 px-3 py-0.5 text-2xl font-semibold tracking-widest uppercase rounded-full"
