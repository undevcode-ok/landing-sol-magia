  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 left-6 z-50 w-20 h-20 rounded-full bg-[rgba(255,255,255,0.15)] border border-white/20 backdrop-blur-sm flex items-center justify-center text-white hover:bg-[#8b2500] hover:border-[#8b2500] transition-all duration-200"
      >
        <ChevronUp size={32} />
      </button>
      ...
      >
        ...
        <div className="w-24 h-24 rounded-full bg-[#25D366] flex items-center justify-center shadow-xl hover:scale-110 transition-transform duration-200">
