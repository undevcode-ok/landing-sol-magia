  ...
  return (
    <>
      ...
      <button
        ...
        className="hidden md:flex fixed bottom-12 left-6 z-50 w-20 h-20 rounded-full bg-[rgba(255,255,255,0.15)] border border-white/20 backdrop-blur-sm items-center justify-center text-white hover:bg-violet-300/40 transition-all duration-200"
      >
        <ChevronUp size={32} />
      </button>
      ...
      <a
        ...
        className="hidden md:flex fixed bottom-12 right-6 z-50 group items-center gap-3"
      >
