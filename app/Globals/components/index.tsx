  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 left-6 z-50 w-20 h-20 rounded-full bg-[rgba(255,255,255,0.15)] border border-white/20 backdrop-blur-sm flex items-center justify-center text-white hover:bg-[#f06060] hover:border-[#f06060] transition-all duration-200"
      >
        <ChevronUp size={40} />
      </button>
      ...
      >
        <span className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-white text-[#1a1a1a] text-[12px] font-medium px-3 py-2 rounded-full whitespace-nowrap shadow-lg">
          Click para Comunicarse →
        </span>
        <div className="w-20 h-20 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-200">
